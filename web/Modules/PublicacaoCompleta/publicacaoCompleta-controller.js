angular.module("tccenter.publicacaoCompleta").controller("PublicacaoCompleteController", function ($scope, $rootScope, $timeout, $location, HomeService, ElementoAtivoFactory, EventosFactory, TccenterStorage, Util, AtalhosFactory) {
